...
function Nav() {
  {
    /* logic for the black navbar when scrolled, also import useState and UseEffect 
 ...
 */
  ...
  return (
    //consition to select the class when scolled
    ...
    <div className="nav">
      ...
      <img
        ...
        src="https://ih1.redbubble.net/image.618410910.2644/flat,750x,075,f-pad,750x1000,f8f8f8.u12.jpg"
        alt="Netflix logo"
      />
    </div>
  );
